 ...
 */
{
  "labels": {
    ...
    "formats": [
      ...
      //${"battleLabelsTemplates.xc":"def.repairCtrlEngine"},
      //${"battleLabelsTemplates.xc":"def.repairCtrlAmmoBay"},
      //${"battleLabelsTemplates.xc":"def.repairCtrlGun"},
      //${"battleLabelsTemplates.xc":"def.repairCtrlTurret"},
      //${"battleLabelsTemplates.xc":"def.repairCtrlComplex"},
      //${"battleLabelsTemplates.xc":"def.repairCtrlSurveying"},
      //${"battleLabelsTemplates.xc":"def.repairCtrlRadio"},
      //${"battleLabelsTemplates.xc":"def.repairCtrlFuelTank"},
      //${"battleLabelsTemplates.xc":"def.healCtrlCommander"},
      //${"battleLabelsTemplates.xc":"def.healCtrlRadioman"},
      //${"battleLabelsTemplates.xc":"def.healCtrlDriver"},
      //${"battleLabelsTemplates.xc":"def.healCtrlGunner"},
      //${"battleLabelsTemplates.xc":"def.healCtrlLoader"}
    ]
  }
}