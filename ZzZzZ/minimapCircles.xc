 ...
 */
{
  "circles": {
    ...
    "view": [
      // Main circles:
      // Основные круги:
      { "enabled": true, "distance": "blindarea", "scale": 1, "thickness": 0.25, "alpha": 25, "color": "0xFFFFFF" },
      { "enabled": true, "distance": 445, "scale": 1, "thickness": 0.25, "alpha": 25, "color": "0xFFFFFF" },
      // Circle of the maximum units appearance.
      // Окружность границы максимальной отрисовки юнитов.
      { "enabled": true, "distance": 564, "scale": 1, "thickness": 1.5, "alpha": 40, "color": "0x02C9B3" },
      // Additional circles:
      // Дополнительные круги:
      { "enabled": true, "distance": 50, "scale": 1, "thickness": 1.0, "alpha": 100, "color": "0xE50000" },
      ...
      { "enabled": true, "distance": "dynamic", "scale": 1, "thickness": 0.75, "alpha": 60, "color": "0xFFFFFF" }
    ],
