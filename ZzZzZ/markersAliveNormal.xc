 ...
 */
{
  ...
  "def": {
    ...
    // Text field with defence icon. 
    // Текстовое поле с иконкой защиты союзника
    "TankDefence": {
      ...
      "format": "<img src='xvm://res/icons/help{{squad}}.png' width='45' height='45'>"
    },
    // Text field with kill icon. 
    // Текстовое поле с иконкой убийства противника
    "TankDestroy": {
      "name": "Уничтожение противника",
      "enabled": true,
      "x": -25,
      "y": -19,
      "alpha": "{{a:hp-ratio}}",
      ...
      "format": "<img src='xvm://res/icons/kill.png' width='45' height='45'>"
    },
    // Text field with tank efficiency star icon. 
    // Текстовое поле со иконкой "звёзды" эффективности на танке
    "TankxTE": {
      "name": "xTE",
      "enabled": true,
      "x": -40,
      "y": -24,
      "alpha": "{{a:t-battles?50|0}}",
      "align": "center",
      "textFormat": {
        "font": "xvm",
        "size": 10,
      ...
      "shadow": {
        ...
        "angle": 45,
        "color": "0x000000",
        "alpha": "{{a:t-battles?100|0}}",
        "blur": 6,
        "strength": 2
      },
      "format": "<font size='{{xvm-stat?10|0}}'>&#x21;</font>"
    }
  },
  // Settings for allies.
