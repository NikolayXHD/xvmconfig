 ...
 */
{
  ...
  "def": {
    ...
    "colorRating": {
      "very_bad":     "0xDD0000",   // very bad   / очень плохо
      "bad":          "0xDD3333",   // bad        / плохо
      "ordinary":     "0xDDDD33",   // ordinary   / посредственно
      "normal":       "0xFFCC33",   // normal     / средне
      "good":         "0x99FF33",   // good       / хорошо
      "very_good":    "0x33FF33",   // very good  / очень хорошо
      "unique":       "0xCC66CC"    // unique     / уникально
    },
    // Dynamic color by remaining health points.
    // Динамический цвет по оставшемуся запасу прочности.
    "colorHP": {
      "very_low":         "0xDD0000",   // very low       / очень низкий
      "low":              "0xDD3333",   // low            / низкий
      "average":          "0xFFCC33",   // average        / средний
      "above_average":    "0xFFFFFF"    // above-average  / выше среднего
    }
  },
  "colors": {
    // System colors.
    ...
    "winrate": [
      { "value": 42,  "color": ${"def.colorRating.very_bad" } },
      { "value": 46,  "color": ${"def.colorRating.bad"      } },
      { "value": 49,  "color": ${"def.colorRating.ordinary" } },
      { "value": 51,  "color": ${"def.colorRating.normal"   } },
      { "value": 53,  "color": ${"def.colorRating.good"     } },
      { "value": 57,  "color": ${"def.colorRating.very_good"} },
    ...
    "kb": [
      ...
      { "value": 12,  "color": ${"def.colorRating.very_good"} },
