 ...
 */
{
  ...
  "def": {
    ...
    "xmqpServiceMarker": {
      "enabled": true,
      "x": -3, "y": 10, "align": "center", "bindToIcon": true,
      "textFormat": {
        "font": "xvm",
        "size": 15
      },
    ...
    "clanIcon": {
      "enabled": true,
      "x": -2, "y": 1, "width": 14, "height": 14, "align": "center", "alpha": 90, "bindToIcon": true,
      "src": "{{clanicon}}"
  ...
  "playersPanel": {
    ...
    "medium": {
      ...
      // Формат отображения имени игрока (допускаются макроподстановки, см. macros.txt).
      "nickFormatLeft": "<font color='{{c:xr}}' alpha='{{alive?#FF|#80}}'>{{name%.15s~..}}</font>",
      "nickFormatRight": "<font color='{{c:xr}}' alpha='{{alive?#FF|#80}}'>{{name%.15s~..}}</font>",
      // Shadow for player name field (default null = no shadow, as in vanillas client).
      // Тень для поля имени игрока (по умолчанию null = без тени, как в чистом клиенте).
      "nickShadowLeft": null,
      "nickShadowRight": null,
    ...
    "medium2": {
      ...
      // Display format for player nickname (macros allowed, see macros.txt).
      // Формат отображения имени игрока (допускаются макроподстановки, см. macros.txt).
      "nickFormatLeft": "<font size='{{xvm-stat?13|0}}' color='{{c:xr}}' alpha='{{alive?#FF|#80}}'>{{r}}</font> {{name%.12s~..}}<font alpha='#A0'>{{clan}}</font>",
      "nickFormatRight": "{{name%.12s~..}}<font alpha='#A0'>{{clan}}</font> <font size='{{xvm-stat?13|0}}' color='{{c:xr}}' alpha='{{alive?#FF|#80}}'>{{r}}</font>",
      // Shadow for player name field (default null = no shadow, as in vanillas client).
      // Тень для поля имени игрока (по умолчанию null = без тени, как в чистом клиенте).
      "nickShadowLeft": null,
      "nickShadowRight": null,
    ...
    "large": {
      ...
      // Display format for player nickname (macros allowed, see macros.txt).
      // Формат отображения имени игрока (допускаются макроподстановки, см. macros.txt).
      "nickFormatLeft": "<font size='{{xvm-stat?13|0}}' color='{{c:winrate}}' alpha='{{alive?#FF|#80}}'>{{winrate%2d~%}}</font> {{name%.{{xvm-stat?{{r_size>2?10|12}}|12}}s~..}}<font alpha='#A0'>{{clan}}</font>",
      "nickFormatRight": "{{name%.{{xvm-stat?{{r_size>2?10|12}}|12}}s~..}}<font alpha='#A0'>{{clan}}</font> <font size='{{xvm-stat?13|0}}' color='{{c:winrate}}' alpha='{{alive?#FF|#80}}'>{{winrate%2d~%}}</font>",
      // Shadow for player name field (default null = no shadow, as in vanillas client).
      // Тень для поля имени игрока (по умолчанию null = без тени, как в чистом клиенте).
      "nickShadowLeft": null,
      "nickShadowRight": null,
