 ...
 */
{
  ...
  "def": {
    ...
    "sd": "0xF59000", // squadman damage  / взводный дамаг
  ...
  "colors": {
    ...
    "damage": {
      ...
      "squadman_enemy_hit":         ${"def.sd"},
      "squadman_enemy_kill":        ${"def.sd"},
      "squadman_enemy_blowup":      ${"def.sd"},
      "squadman_allytk_hit":        ${"def.tk"},
      "squadman_allytk_kill":       ${"def.tk"},
      "squadman_allytk_blowup":     ${"def.tk"},
      "squadman_enemytk_hit":       ${"def.sd"},
      "squadman_enemytk_kill":      ${"def.sd"},
      "squadman_enemytk_blowup":    ${"def.sd"},
